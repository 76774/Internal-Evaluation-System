...
{
include("cont.php");
$p="insert into marks(marksid,rollno,name,stream,semester,subject,test,session,maxmarks,obtmarks,attendancemarks,total,date,refstudentid)
values('$sid',$roll,'$sname','$stream','$semester','$subject','$tes','$session','$max','$obt','$att','$tot','$dt','$studentid')";
...
<form action="marks_form2.php" method="post">
<div align="center">
  <center>
    ...
    <tr>
      ...
      <div align="center">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="96%" height="346" class="regtab">
          <tr>
            <td width="100%" colspan="7" class="title" id="border_bottom" height="45">Marks form 2</td>
          </tr>
          <tr>
...
<select size="1" name="roll" id="roll" class="regdrop" onchange="return studentinfo();">
  ...
  <option value='<?=$res[0].",".$res[1].",".$res[2]?>'> <?=$res[0]?> </option>
          ...
          <tr>
            ...
            <td width="17%" height="47" class="labels" id="border_bottom" >Internal Exam</td>
            <td width="25%" height="47" id="border_bottom" ><input type="text" name="tes" size="20" class="textbox" value = '<?=$tes?>' autocomplete="off" > </td>
            <td width="16%" height="47" id="border_bottom" >&nbsp;</td>
          </tr>
          <tr>
            <td width="2%" height="47" id="border_bottom" >&nbsp;</td>
          ...
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0"  width="100%" height="35">
              <tr>
                ...
                <input type="text" name="att" size="9" class="textbox1" autocomplete="off"></td>
                <td width="36%" height="35" class="labels"> <center>Total</center></td>
                <td width="31%" height="35"><input type="text" name="tot" size="6" class="textbox1" autocomplete="off"></td>
              </tr>
            </table>
            </td>
            <td width="16%" height="47" id="border_bottom" >&nbsp;</td>
