...
$p="update student_detail set name='$n',parentage='$parentage',gender='$gender',dateofbirth='$dob',contactno='$no',guardiancontactno='$gno',category='$category',session='$ses',stream='$stream',subject='$subject',semester='$sem',classrollno='$roll',address='$add' where studentid='$sid'";
...
<form action="student_update_faculty.php" method="post" enctype="multipart/form-data">
