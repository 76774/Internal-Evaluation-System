...
header("location:assignment_form2.php");
}
}
...
<form action="assignment_form1.php" method="post">
<div align="center">
  <center>
...
<select size="1" name="sub" class="regdrop">
  ...
  <option value="<?=$res[0]?>"> <?=$res[0]?> </option>
          ...
          <td width="14%" height="47" class="labels" id="border_bottom">
          Assignment</td>
